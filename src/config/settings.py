...
class Settings(BaseSettings):
    ...
    # OpenRouter Settings (default provider)
    ...
    login_wait_timeout: int = Field(default=300_000, gt=0)
    ...
    def validate_api_key_present(self) -> "Settings":
        # Skip validation — key presence is checked at runtime when AI is invoked
        return self
